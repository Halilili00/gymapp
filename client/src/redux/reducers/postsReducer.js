import { GET_POSTS, CREATE_POST, GET_POST_WITH_ID, DELETE_POST, UPDATE_POST, LIKE, GET_USER_POSTS, GET_ALL_POSTS } from "../actions/actionsType";
...
export default function postsReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case LIKE:
      return {...state, posts: state.posts.map((post) => post._id === action.payload._id ? action.payload : post), post: initialState.post}
    default:
      return state;
  }
}
